...
public class Test_main {
    ...
    public void setUp() throws Exception{
        ...
        buscador = new Buscador(new File("").getAbsolutePath() + "/archivos/recetas/");
    }
    ...
    public void buscarPique() throws Exception {
        String nombre = "Pique";
        assertEquals("pique.txt", buscador.buscarReceta(nombre).getName());
    }
    ...
    public void verificarRecetaSinIngrediente() {
        ...
        assertEquals(17, buscador.buscarRecetaSinIngredientes(ingrediente).size());
    }

    @Test
    public void recetasSinIngredientes() {
        String[] ingredientes = {"Chocolate", "pollo"};
        assertEquals(11, buscador.buscarRecetaSinIngredientes(ingredientes).size());
    }
    ...
    public void testSugerirSopas() throws Exception {
        ...
        assertEquals(5, buscador.sugerirRecetas(receta).size());
    }
